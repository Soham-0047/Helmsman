...
**Run:** 50 fixture issues · mode: `local-fallback (deterministic)` · 2026-05-30T10:52:56.173781+00:00

| Metric | Single-agent baseline | Seven-agent Helmsman | Δ |
|---|---|---|---|
| Classification accuracy | 70% | **80%** | +10 pp |
| Response quality (1–5, LLM-judge) | 1.00 | **3.66** | +2.66 |
| Voice similarity (cosine vs. maintainer) | 0.259 | **0.385** | +0.126 |
