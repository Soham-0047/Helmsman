...
| **Feature flags** | Canary controls via `admin.isFlagEnabled(key, ctx)`: `helmsman.auto_close_duplicates`, `helmsman.use_long_context_analyzer`, `helmsman.voice_self_check`, `helmsman.rpa_dry_run`. |
...
**Run:** 50 fixture issues · mode: `local-fallback (deterministic)` · 2026-05-29T20:20:27.310727+00:00

| Metric | Single-agent baseline | Seven-agent Helmsman | Δ |
|---|---|---|---|
| Classification accuracy | 70% | **78%** | +8 pp |
| Response quality (1–5, LLM-judge) | 1.00 | **3.68** | +2.68 |
| Voice similarity (cosine vs. maintainer) | 0.259 | **0.383** | +0.124 |
| Avg time per issue | 0 ms | 5 ms | — |
